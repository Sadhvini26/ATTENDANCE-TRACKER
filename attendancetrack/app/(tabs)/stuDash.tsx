...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    // For now, we'll just simulate the loading with a timeout
  ...
  if (!fontsLoaded) {
    // Simple loading screen instead of AppLoading
    return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.menuGrid}>
        ...
        <View style={styles.menuRow}>
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('NB')}>
        ...
        <View style={styles.menuRow}>
          <TouchableOpacity style={styles.menuItem}>
            ...
            <Text style={styles.menuItemText}>Clubs</Text>
          </TouchableOpacity>
